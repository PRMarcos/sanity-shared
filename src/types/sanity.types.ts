...
// Query: *[_type == "sermonSummary" && isActive == true] {   _id,      title,   date,  tags[]->{_id,title},   "slug": slug.current,   "background": background.asset->url,   speaker->{ name, titleAbbreviation, photo},    }
